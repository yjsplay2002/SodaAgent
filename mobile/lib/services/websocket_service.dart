...
class WebSocketService {
              ...
              (data) {
                if (data is String) {
                  try {
                    ...
                    final preview = (json['text'] ?? json['name'] ?? '')
                        .toString();
                    debugPrint(
                      'WS: Received [${json['type']}] ${preview.length > 60 ? preview.substring(0, 60) : preview}',
                    );
                  ...
                  debugPrint(
                    'WS: Received non-string data: ${data.runtimeType}',
                  );
                }
              },
              onDone: () {
  ...
  void sendText(String text) {
    ...
    debugPrint(
      'WS: Sending text: ${text.length > 60 ? text.substring(0, 60) : text}',
    );
